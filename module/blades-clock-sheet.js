...
export class BladesClockSheet extends BladesSheet {
  ...
  async _updateObject(event, formData) {
    let image_path = clockToDataUri( "systems/blades-in-the-dark/styles/assets/progressclocks-svg/Progress Clock ${formData['system.type']}-${formData['system.value']}.svg", formData['system.fill_color'] );
